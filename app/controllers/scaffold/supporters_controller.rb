class Scaffold::SupportersController < ApplicationController
  # GET /supporters
  # GET /supporters.xml
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @supporter.save
        format.html { redirect_to([:scaffold, @supporter], :notice => 'Supporter was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @supporter.update_attributes(params[:supporter])
        format.html { redirect_to([:scaffold, @supporter], :notice => 'Supporter was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(scaffold_supporters_url) }
      format.xml  { head :ok }
    end
  end
end
