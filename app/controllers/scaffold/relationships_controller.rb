class Scaffold::RelationshipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @relationship.save
        format.html { redirect_to([:scaffold, @relationship], :notice => 'Relationship was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @relationship.update_attributes(params[:relationship])
        format.html { redirect_to([:scaffold, @relationship], :notice => 'Relationship was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(scaffold_relationships_url) }
      format.xml  { head :ok }
    end
  end
end
